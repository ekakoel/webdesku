...
class VillageIdentity
{
    ...
    private static function adminPageTitle(string $routeName): string
    {
        return match (true) {
            ...
            Str::startsWith($routeName, 'admin.village-hamlets.') => 'Kelola Banjar',
            Str::startsWith($routeName, 'admin.village-household-welfares.') => 'Data Desil Kesejahteraan',
