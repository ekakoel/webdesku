...
class ServiceController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated['slug'] = $this->makeUniqueSlug($validated['name'], (int) $village->id);
    ...
    public function update(Request $request, VillageService $service): RedirectResponse
    {
        ...
        if ($service->isDirty('name')) {
            $service->slug = $this->makeUniqueSlug($validated['name'], (int) $service->village_id, $service->id);
        }
    ...
    private function makeUniqueSlug(string $name, int $villageId, ?int $ignoreId = null): string
    {
        $base = Str::slug($name);
