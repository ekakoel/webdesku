...
<div class="space-y-5">
    ...
    <div>
        <label for="title" class="block text-sm font-medium text-gray-700">Judul Dokumen/Laporan APBDes</label>
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.village-apbdes-documents.index') }}" class="text-sm text-gray-600 hover:underline">Batal</a>
    </div>
</div>
