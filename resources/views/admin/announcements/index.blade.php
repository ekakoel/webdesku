        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 overflow-x-auto">
                    <form method="GET" action="{{ route('admin.announcements.index') }}" class="mb-4 grid gap-3 md:grid-cols-[1fr_220px_auto_auto]">
                        <input type="text" name="q" value="{{ $keyword ?? '' }}" placeholder="Cari judul/isi..." class="rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <a href="{{ route('admin.announcements.index') }}" class="inline-flex items-center justify-center rounded-md border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">Reset</a>
                    </form>
                        ...
                        <tbody>
                            @forelse ($announcements as $announcement)
                                <tr class="border-b">
                                    ...
                                    <td class="px-3 py-3">
                                        <span class="inline-flex items-center rounded-full px-2 py-1 text-xs font-semibold text-white" style="background: {{ $announcement->typeColor() }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-3 py-6 text-center text-gray-500">Belum ada data pengumuman.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
