@php
    ...
    $resourceLabels = [
        ...
        'village-transparency-documents' => 'Dokumen Transparansi',
        'village-apbdes-items' => 'APBDes',
        'village-apbdes-documents' => 'Dokumen/Laporan APBDes',
        ...
        'village-land-use-areas' => 'Luas Wilayah',
        'data-lineage' => 'Data Lineage & Governance',
    ];
    ...
    $groupLabels = [
        ...
        'village-transparency-documents' => 'Infografis & Transparansi',
        'village-apbdes-items' => 'Infografis & Transparansi',
        'village-apbdes-documents' => 'Infografis & Transparansi',
        ...
        'village-land-use-areas' => 'Profil & Organisasi Desa',
        'data-lineage' => 'Profil & Organisasi Desa',
    ];
    ...
    $resourceRoutes = [
        ...
        'regulations' => 'admin.regulations.index',
        ...
        'village-transparency-documents' => 'admin.village-transparency-documents.index',
        'village-apbdes-items' => 'admin.village-apbdes-items.index',
        'village-apbdes-documents' => 'admin.village-apbdes-documents.index',
        ...
        'village-land-use-areas' => 'admin.village-land-use-areas.index',
        'data-lineage' => 'admin.data-lineage.index',
    ];
